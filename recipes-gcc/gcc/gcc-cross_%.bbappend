...
DEPENDS:virtclass-mcextendcross-arm-none-eabi = "binutils-cross-arm-none-eabi
${EXTRADEPENDS} ${NATIVEDEPS}"
PROVIDES:virtclass-mcextendcross-arm-none-eabi = ""

GCCMULTILIB:virtclass-mcextendcross-arm-none-eabi = "--enable-multilib
...
EXTRA_OECONF:append:virtclass-mcextendcross-arm-none-eabi = "
--with-sysroot= --with-headers=no --disable-gcov --disable-threads"
